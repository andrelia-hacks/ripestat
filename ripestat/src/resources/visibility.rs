...
use ripestat_common::VisibilityRequest;

pub async fn visibility(request: VisibilityRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::Visibility;
