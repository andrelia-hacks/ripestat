...
use ripestat_common::RoutingStatusRequest;

pub async fn routing_status(request: RoutingStatusRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RoutingStatus;
