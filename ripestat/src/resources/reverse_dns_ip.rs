...
use ripestat_common::ReverseDnsIpRequest;

pub async fn reverse_dns_ip(request: ReverseDnsIpRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::ReverseDnsIp;
