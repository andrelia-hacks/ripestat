...
use ripestat_common::AnnouncedPrefixesRequest;

pub async fn announced_prefixes(request: AnnouncedPrefixesRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
