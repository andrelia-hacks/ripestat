...
pub async fn maxmind_geo_lite_announced_by_as(request: MaxmindGeoLiteRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::MaxmindGeoLiteAnnouncedByAs;
