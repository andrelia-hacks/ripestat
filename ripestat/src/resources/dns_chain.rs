...
use ripestat_common::DnsChainRequest;

pub async fn dns_chain(request: DnsChainRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::DnsChain;
