...
use ripestat_common::AtlasProbeDeploymentRequest;

pub async fn atlas_probe_deployment(request: AtlasProbeDeploymentRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AtlasProbeDeployment;
