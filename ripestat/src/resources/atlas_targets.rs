...
use ripestat_common::AtlasTargetsRequest;

pub async fn atlas_targets(request: AtlasTargetsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AtlasTargets;
