...
use ripestat_common::RirGeoRequest;

pub async fn rir_geo(request: RirGeoRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RirGeo;
