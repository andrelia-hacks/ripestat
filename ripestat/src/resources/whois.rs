...
use ripestat_common::WhoisRequest;

pub async fn whois(request: WhoisRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::Whois;
