...
use ripestat_common::MlabClientsRequest;

pub async fn mlab_clients(request: MlabClientsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::MlabClients;
