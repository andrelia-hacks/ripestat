...
use ripestat_common::RirRequest;

pub async fn rir(request: RirRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::Rir;
