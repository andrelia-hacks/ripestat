...
use ripestat_common::ReverseDnsRequest;

pub async fn reverse_dns(request: ReverseDnsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::ReverseDns;
