...
use ripestat_common::SpeedcheckerBandwidthMeasurementsRequest;

pub async fn speedchecker_bandwidth_measurements(request: SpeedcheckerBandwidthMeasurementsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::SpeedcheckerBandwidthMeasurements;
