...
use ripestat_common::MlabBandwidthRequest;

pub async fn mlab_bandwidth(request: MlabBandwidthRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::MlabBandwidth;
