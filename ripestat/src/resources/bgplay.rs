...
use ripestat_common::BgplayRequest;

pub async fn bgplay(request: BgplayRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::Bgplay;
