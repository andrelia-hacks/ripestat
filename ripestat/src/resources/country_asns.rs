...
use ripestat_common::CountryAsnsRequest;

pub async fn country_asns(request: CountryAsnsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::CountryAsns;
