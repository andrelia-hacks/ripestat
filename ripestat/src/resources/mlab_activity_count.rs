...
use ripestat_common::MlabActivityCountRequest;

pub async fn mlab_activity_count(request: MlabActivityCountRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::MlabActivityCount;
