...
use ripestat_common::BgpUpdatesRequest;

pub async fn bgp_updates(request: BgpUpdatesRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::BgpUpdates;
