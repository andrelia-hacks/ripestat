...
use ripestat_common::PrefixRoutingConsistencyRequest;

pub async fn prefix_routing_consistency(request: PrefixRoutingConsistencyRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::PrefixRoutingConsistency;
