...
use ripestat_common::RisPeeringsRequest;

pub async fn ris_peerings(request: RisPeeringsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RisPeerings;
