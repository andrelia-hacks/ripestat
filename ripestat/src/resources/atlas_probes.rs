...
use ripestat_common::AtlasProbesRequest;

pub async fn atlas_probes(request: AtlasProbesRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AtlasProbes;
