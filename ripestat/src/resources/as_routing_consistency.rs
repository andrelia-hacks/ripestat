...
use ripestat_common::AsRoutingConsistencyRequest;

pub async fn as_routing_consistency(request: AsRoutingConsistencyRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AsRoutingConsistency;
