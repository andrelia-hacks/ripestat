...
use ripestat_common::RisFullTableThresholdRequest;

pub async fn ris_full_table_threshold(request: RisFullTableThresholdRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RisFullTableThreshold;
