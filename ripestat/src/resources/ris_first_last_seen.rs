...
use ripestat_common::RisFirstLastSeenRequest;

pub async fn ris_first_last_seen(request: RisFirstLastSeenRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RisFirstLastSeen;
