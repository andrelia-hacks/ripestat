...
use ripestat_common::NetworkInfoRequest;

pub async fn network_info(request: NetworkInfoRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::NetworkInfo;
