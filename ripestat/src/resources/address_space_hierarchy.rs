...
use ripestat_common::AddressSpaceHierarchyRequest;

pub async fn address_space_hierarchy(request: AddressSpaceHierarchyRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AddressSpaceHierarchy;
