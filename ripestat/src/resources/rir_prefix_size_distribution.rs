...
use ripestat_common::RirPrefixSizeDistributionRequest;

pub async fn rir_prefix_size_distribution(request: RirPrefixSizeDistributionRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::RirPrefixSizeDistribution;
