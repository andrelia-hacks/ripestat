...
use ripestat_common::MeternetBandwidthMeasurementsRequest;

pub async fn meternet_bandwidth_measurements(request: MeternetBandwidthMeasurementsRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::MeternetBandwidthMeasurements;
