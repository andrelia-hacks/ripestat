...
use ripestat_common::AsOverviewRequest;

pub async fn as_overview(request: AsOverviewRequest, client: &client::Client) -> Result<RipeStatResponse, RipestatClientError> {
    let data_type = RipeStatDataType::AsOverview;
